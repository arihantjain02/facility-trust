  ...
  head: () => ({
    meta: [
      ...
      { title: "RELI-REF — Evidence-driven referral reliability" },
      {
        name: "description",
        content:
          "RELI-REF tracks facility, service and time evidence so public-health referral staff can choose destinations that are actually working right now.",
      },
      { name: "author", content: "Tech Alchemists" },
